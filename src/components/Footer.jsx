...
const Footer = () => {
  ...
  const onAboutUs = () => {
    ...
    navigate("/about"); // ✅ Navigates to the route
  };
  return (
    <footer className="bg-[#6F272B] text-white py-10 px-6">
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li><a href="#" className="hover:text-blue-600" onClick={onAboutUs}>About Us</a></li>
